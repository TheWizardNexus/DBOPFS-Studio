...
DBOPFS Studio and its bundled DBOPFS runtime are publicly available under the
...
[commercial-license request](https://github.com/TheWizardNexus/DBOPFS-Studio/issues/new?title=Commercial%20license%20request).
Do not include confidential, payment, or credential information in a public
issue; the licensor will provide a private contact path for the agreement.

The public noncommercial license remains available for uses it permits.
